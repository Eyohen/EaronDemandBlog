...
const Dashboard = () => {
  ...
  const fetchProfile = async () => {
    ...
    console.error('Access token not found')
       ...
       const res = await axios.get(URL+"/api/user/"+currentUser?._id, {
        headers: {
  ...
  <div className="flex justify-between items-center px-4">
    ...
    <div>
    <p onClick={logOut} className='flex justify-center font-semibold bg-red-400 text-white text-xl px-auto rounded-md mt-2 cursor-pointer'>{user? 'Log Out' : 'Login'}</p>
